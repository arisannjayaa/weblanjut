        ...
        <form action="<?=base_url('mahasiswa/add')?>" method="post">
            <table>
                <tr>
                    <td>NIM</td>
                    <td>:</td>
                    <td><input type="text" class="form-control ms-3" name="nim"></td>
                </tr>
                <tr>
                    <td>Nama</td>
                    <td>:</td>
                    <td><input type="text" class="form-control ms-3" name="nama"></td>
                </tr>
                <tr>
                    <td>Jurusan</td>
                    <td>:</td>
                ...
                <tr>
                    <td>Tlp</td>
                    <td>:</td>
                    <td><input type="text" class="form-control ms-3" name="tlp"></td>
                </tr>
                <tr>
                    <td>Alamat</td>
                    <td>:</td>
                    <td><textarea name="alamat" id="alamat" class="form-control ms-3"></textarea></td>
                </tr>
